...
public class GameBoard {
    ...
    private int countNearbyLandMines(CellPosition cellPosition) {
        ...
        long count = calculateSurroundedPositions(cellPosition, rowSize, colSize).stream()
                .filter(nextPosition -> isLandMineCellAt(nextPosition))
                .count();
    ...
    private List<CellPosition> calculateSurroundedPositions(CellPosition cellPosition, int rowSize, int colSize) {
        return RelativePosition.SURROUNDED_POSITIONS.stream()
                ...
                .filter(nextPosition -> nextPosition.isRowIndexLessThan(rowSize))
                .filter(nextPosition -> nextPosition.isColIndexLessThan(colSize))
                .toList();
    }
    ...
    private void openSurroundedCells(CellPosition cellPosition) {
        ...
        surroundedPositions
                .forEach(nextCellPosition -> openSurroundedCells(nextCellPosition));
